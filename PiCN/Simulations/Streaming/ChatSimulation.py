...
chat_tool1 = Chatclient("icn1", None, 255, NdnTlvEncoder(), interfaces=[simulation_bus.add_interface("chattool1")])
...
#mgmt_client0.add_new_content(Name("/data/obj1"), "Ping")
#mgmt_client1.add_new_content(Name("/data/obj1"), "Pong")
#name0 = Name("/data/obj1")
#name1 = Name("/data/obj1")

chat_tool0.send_message(1, "Hello World")
